  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-3 sm:mb-4">
        <Filter className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: '#374151' }} />
        <h3 className="font-semibold text-base sm:text-lg" style={{ color: '#111827' }}>
          {t('manager.filters')}
        </h3>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <div className="relative">
            <Search 
              className="absolute left-3 top-1/2 w-3.5 h-3.5 sm:w-4 sm:h-4" 
              style={{ 
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-md px-3 py-2 text-xs sm:text-sm font-medium transition-colors outline-none focus:ring-2"
            style={{
              height: '2.25rem',
              backgroundColor: '#ffffff',
