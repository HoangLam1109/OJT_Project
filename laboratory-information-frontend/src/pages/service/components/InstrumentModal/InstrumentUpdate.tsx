      ...
      <DialogContent className="max-w-2xl overflow-hidden border-0 shadow-2xl sm:rounded-2xl">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 pt-2 border-t border-gray-100">
            {/* Status Section */}
            <div className="space-y-2">
                <Label className="text-sm font-medium text-gray-700">{t('service.instrument.status')}</Label>
                <div className="relative group">
                    ...
                    <SelectTrigger className="pl-10 h-11 bg-white border-gray-200 text-gray-900 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all">
