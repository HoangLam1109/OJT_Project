                ...
                <div className="p-6 space-y-8">
                    ...
                    <div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                            <div>
                                <span className="font-medium text-gray-700 block mb-2">{t('reagent.detailModal.notes')}:</span>
                                <p className="text-gray-600 bg-white p-3 rounded border border-gray-200 min-h-[60px]">
